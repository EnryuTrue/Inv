...
import { Plus, Minus, ArrowLeft, User, Building, Calendar } from "lucide-react-native";
...
export default function CreateProformaInvoiceScreen() {
  ...
  const handleSaveDraft = () => {
    ...
    try {
      const proformaNotes = `PROFORMA INVOICE - NOT A TAX INVOICE\n\nThis is an estimated bill for approval before final invoice.\n${estimatedDeliveryDate ? `Estimated Delivery: ${estimatedDeliveryDate}\n` : ""}${notes.trim() ? `\nNotes: ${notes.trim()}` : ""}`;
      ...
      Alert.alert("Success", "Proforma invoice saved as draft", [
        { text: "OK", onPress: () => router.back() }
      ]);
    } catch (error) {
      Alert.alert("Error", "Failed to save proforma invoice");
    }
  };
  ...
  const handleSendProforma = () => {
    ...
    try {
      ...
      Alert.alert("Success", "Proforma invoice sent successfully", [
        { text: "OK", onPress: () => router.back() }
      ]);
    } catch (error) {
      Alert.alert("Error", "Failed to send proforma invoice");
    }
  };
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        {/* Proforma Notice */}
        <View style={styles.proformaNotice}>
          <Text style={styles.proformaNoticeText}>
            📋 This is a Proforma Invoice - an estimated bill for client approval before creating the final invoice.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.deliveryDateContainer}>
            ...
            <TextInput
              ...
              placeholder="e.g., 2-3 weeks, March 15, 2024"
      ...
      <View style={styles.actionButtons}>
        ...
        <TouchableOpacity style={styles.sendButton} onPress={handleSendProforma}>
          <Text style={styles.sendButtonText}>Send Proforma</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
